...
import { Zap, Mail, Lock, Loader2, User, Building2 } from 'lucide-react';
...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Registration successful! Welcome to DentalOS.');
      navigate('/dashboard');
    } catch (error: any) {
    ...
    <div className="min-h-screen pt-24 md:pt-32 pb-12 px-4 flex items-center justify-center bg-background relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h1 className="text-3xl font-black tracking-tight mb-2">Start Free Trial</h1>
          <p className="text-secondary text-sm">Join 2,000+ modern dental clinics worldwide</p>
        </div>
          ...
          <div className="space-y-3">
            <div className="relative group">
              ...
              <input
                ...
                className="w-full h-11 pl-12 pr-4 bg-background border border-border rounded-xl focus:ring-2 focus:ring-accent transition outline-none text-sm"
              />
            </div>
            <div className="relative group">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-card px-2 text-secondary/50 font-bold tracking-widest">Or sign up with</span>
          </div>
        </div>
